         ...
         <nav class="navbar navbar-expand-lg navbar-dark" id="gradient">
          ...
          <div class="container-fluid">
               <div class="card mb-3">
                  ...
                  <!-- search $result     -->
                  <div style="position:absolute;background-color:#f2f2f2 ;width:450px;height:250px;margin-left:500px;margin-top:70px;">
                    <?php
                          echo "<h6>Name : ";
                          ...
                          echo "<br>";
                          echo "<h6>Department : ";
                          echo $_SESSION['f_branch'],'   ' .$_SESSION['f_sem'],'  '.$_SESSION['f_section'];
                          echo "</h6>";
                          echo "<br>";
                          echo "<h6>Email : ";
