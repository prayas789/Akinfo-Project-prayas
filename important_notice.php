<?php
        session_start();
         ...
         $sql = "SELECT * FROM photos WHERE imp='1' ";
...
img {
    ...
    <body>
     ...
     <div class="col-md-9">
         ...
         <nav class="navbar navbar-expand-lg navbar-dark" id="gradient">
          ...
          <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dashboard/ Important Notice</li>
               </ol>
          </nav>
         ...
         <div class="footer">
               <div class="container">
                    <span class="text-white"><center>Copyright &copy; 2018, Aknifo. All Rights Reserved.</center></span>
               </div>
          </div>
