<?php
        ...
        $sql = "SELECT * FROM assig WHERE branch='$branch1'";
        $result = mysqli_query($db, $sql);
        $url = $_SESSION['url'];

        if(isset($_GET['delete'])){
          $id = $_GET['delete'];
          $e = "DELETE FROM assig WHERE sno = '$id'";
          $new = mysqli_query($db,$e);
          }
          ...
          <nav class="navbar navbar-expand-xs navbar-light bg-white">
               ...
               <div class="collapse navbar-collapse show" id="sidenav">
                    <ul class="navbar-nav mr-auto">
                         ...
                         <li class="nav-item active ">
                              <a class="nav-link" href=""><i class="fa fa-bullhorn"></i>Dashboard Assignments</a>
                         </li>
               ...
               <div class="card mb-3">
                    ...
                    <table class="table">
                         ...
                         <tbody>
                          ...
                          echo   "<br>";
                          echo   "<h5 class='btn btn-primary'>Uploaded On :  ".$row['val1']." </h5>";
                          echo   "<br><br>";
                          echo   "<h5 class='btn btn-primary'>Deadline :  ".$row['val2']."</h5>";
                          echo   "<br><br>";
                          echo   "<h5 class='btn btn-primary'>Additional Information :</h6>";
                          echo   "<div style='width:430px;height:380px;border:'>";
                          echo   $row['text'];
                          echo   "</div>";
                          echo   "</div>";
                          echo   "</div>";
                          $p = $row['sno'];
                          echo "<a class='btn btn-primary' href='f_assig_view.php?delete=$p' >DELETE</a>";
