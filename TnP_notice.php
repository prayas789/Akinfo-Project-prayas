<?php
         ...
         $sql = "SELECT * FROM photos WHERE imp='2'";
          ...
          <nav class="navbar navbar-expand-xs navbar-light bg-white">
               ...
               <div class="collapse navbar-collapse show" id="sidenav">
                    <ul class="navbar-nav mr-auto">
                         ...
                         <li class="nav-item">
                              <a class="nav-link active" href="TnP_notice.php"><i class="fa fa-pencil"></i><font size="5"> T&P Notice</font></a>
                         </li>
                         <li class="nav-item">
         ...
         <nav class="navbar navbar-expand-lg navbar-dark" id="gradient">
          ...
          <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dashboard/ T&P notices</li>
               </ol>
          </nav>
          ...
          <div class="container-fluid">
               <div class="card mb-3">
                    <div class="card-header">
                         Training and Placement Notice's
                    </div>
                    <table class="table">
                         <thead>
                              <tr>
