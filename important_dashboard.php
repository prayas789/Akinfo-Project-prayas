          ...
          <nav class="navbar navbar-expand-xs navbar-light bg-white">
               ...
               <div class="collapse navbar-collapse show" id="sidenav">
                    <ul class="navbar-nav mr-auto">
                         ...
                         <li class="nav-item active">
                              <a class="nav-link" href="admin_update.php"><i class="fa fa-dashboard"></i> Admin Panal<span class="sr-only">(current)</span></a>
                         </li>
                         <li class="nav-item">
                         ...
                         <li class="nav-item">
                              <a class="nav-link" href="#"><i class="fa fa-bullhorn"> New Updates</i></a>
                         </li>
                    </ul>
               </div>
          </nav>
               ...
               <div class="card mb-3">
                    ...
                    <img id="image1" src="#" style="margin-left:20px;height:400px;width:300px;border: solid;">
                      ...
                      <div style="right : 0px;margin-left:330px;margin-top:-400px;height:400px;width:600px;">
                        <form action="image_notice.php" method="post" enctype="multipart/form-data" runat="server">
                          ...
                          <br><br>
                          <select class="wrap-input100 input100" name="imp">
              												<option >--Type--</option>
